...
class ExpandableOfferDescriptionSection extends StatefulWidget {
  ExpandableOfferDescriptionSection({
    this.title,
  });
  ...
  @override
  _ExpandableOfferDescriptionSectionState createState() =>
      _ExpandableOfferDescriptionSectionState();
}

class _ExpandableOfferDescriptionSectionState
    extends State<ExpandableOfferDescriptionSection> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SmallNameValue(
              name: 'Valid from:',
              value: _offerDetailsViewModel.offer.validFrom,
            ),
            ...
            Visibility(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SmallNameValue(
                    name: 'ExpiryDate:',
                    value: _offerDetailsViewModel.offer.expiryDate,
                  ),
